        ...
        await fetch(APIURL + urlString, RequestOptions)
            ...
            .then(data => {
                productData = {
                    ...
                    "shelfLife": data.product.shelfLife == null ? "" : data.product.shelfLife,
                    "instructionsToStore": data.product.instructionsToStore == null ? "" : data.product.instructionsToStore,
                    "usages": data.product.usages == null ? "" : data.product.usages,
                    "certification": data.product.certification == null ? "" : data.product.certification,
                    "seed": data.product.seed == null ? "" : data.product.seed,
                    "salePrice": data.salePrice == null ? 0 : data.salePrice,
